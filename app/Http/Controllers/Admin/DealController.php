...
class DealController extends Controller
{
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('action', function($row){
                    if($row->status == 'Yes') 
                        $action = '
                            ...
                            <a href="'.url('admin/deals').'/'.$row->id.'" class="btn btn-success btn-sm-custom waves-effect waves-float waves-light"><i class="far fa-eye"></i></a>
                            <a href="'.url('admin/deals').'/'.$row->id.'/edit" class="btn btn-primary btn-sm-custom waves-effect waves-float waves-light"><i class="fas fa-pencil-alt"></i></a>
        ...
        return view('admin.offer_coupons.manage_hot_deals');
    }
    ...
    public function create()
    {
        ...
        return view('admin.offer_coupons.create_hot_deal', compact('categories'));
    }
    ...
    {
        $picked = Deal::find($id);
        return view('admin.offer_coupons.view_hot_deal', compact('picked'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.offer_coupons.edit_hot_deal', compact('categories', 'picked', 'categories', 'sub_categories', 'food_items'));
    }
    ...
    public function destroy($id)
    {
        try{
            $picked = Deal::find($id);
            $picked->delete();
            return $this->success('Deal Deleted Sucecssfully.', null);
        }catch(\Exception $e) {
    ...
    public function changeStatus(Request $request) {
        try{
            $picked = Deal::find($request->id);
            $status = $picked->status == 'Yes' ? 'No' : 'Yes';
            $msg    = $picked->status == 'Yes' ? 'Deal Blocked Sucecssfully.' : 'Deal Activated Sucecssfully.';
            $picked->update(
                [
                    'status' => $status
                ]

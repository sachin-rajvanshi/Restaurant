    ...
    <div class="content-header row">
      ...
      <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrumb-right">
          <div class="dropdown">
            <a href="{{ url('admin/coupons/create') }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">Add Coupons</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="coupons-list">
                  <thead>
                    <tr>
                      <th>ID</th>
...
<script type="text/javascript">
  $(function () {
    var table = $('#coupons-list').DataTable({
        processing: true,
        serverSide: true,
        render: true,
        searching: true,
  ...
  function changeStatus(id) {
      swal({
          title: "Are you sure?",
          text: "Change Status Of This Coupon.",
          icon: "warning",
          buttons: true,
          dangerMode: true,
      })
      .then((willDelete) => {
        if (willDelete) {
            $.ajax({
              url: '{{ url('admin/coupons/change-status') }}',
              method: "POST",
              data: {
                "_token": "{{ csrf_token() }}",
                'id': id
              ...
              success: function(response) {
                ...
                if(response.code === 200) {
                  ...
                  $('#coupons-list').DataTable().ajax.reload();
                }else {

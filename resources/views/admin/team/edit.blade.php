      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{ url('admin/team') }}/{{ $user->id }}" enctype="multipart/form-data">
              	@csrf
                @method('PATCH')
                <div class="row">
                  <div class="col-md-2">
                          ...
                          <span class="input-group-btn">
                            <span class="btn-file">
                              ...
                              @if (Storage::exists($user->profile_photo)) 
                                <img id='upload-img' class="img-upload-block" src="{{ asset('storage/'.$user->profile_photo) }}" alt="">
                              @else
            ...
            @endif
                  ...
                  <div class="col-md-12">
                    <button class="btn btn-primary waves-effect waves-float waves-light" type="submit">Update Team</button>
                  </div>
                </div>
              </form>
            </div>

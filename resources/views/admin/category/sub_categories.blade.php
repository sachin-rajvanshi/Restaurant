    ...
    <div class="content-header row">
      ...
      <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrumb-right">
          <div class="dropdown">
            <a href="{{ url('admin/category/create') }}?parent={{ base64_encode($p_id) }}" class="btn-icon btn btn-primary btn-round btn-sm dropdown-toggle">Add Child Category</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Manage Sub Categories List</h4>
            </div>
            <div class="card-body">
...
<script type="text/javascript">
  $(function () {
    var table = $('#categories-list').DataTable({
        ...
        render: true,
        searching: true,
        ajax: "{{ url('admin/manage/sub/categories') }}/"+'{{ base64_encode($p_id) }}',
        columns: [
